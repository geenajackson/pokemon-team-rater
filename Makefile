...
# targets
.PHONY: all
all: sanity-check git help homebrew just install mpr tldr update xcode
...
install: sanity-check update xcode homebrew git python pip mpr just tldr  ## install all dependencies
